...
# Bubble Rune
The project is a deployment of the four-point model of Jiaolong Team of Shanghai JiaoTong University. The main change to the code is the addition of the ROS interface so that the detector inference results can be run in Bubble.

The original author of this packages is harry-hhj, and the project uses the [GPL3.0 license](https://github.com/Harry-hhj/CVRM2021-sjtu/blob/main/LICENSE). The original address of the project is [CVRM2021-sjtu](https://github.com/Harry-hhj/CVRM2021-sjtu#%E5%9B%9B%E7%82%B9%E6%A8%A1%E5%9E%8B)
