...
# Bubble Traditional CV Detector
This project maintains the detector module in [Bubble](https://github.com/Birdiebot/bubble) project. The module detect armor through traditional computer vision algorithms and returns the results to other packages. See the Documentation section for specific algorithm implementation.
